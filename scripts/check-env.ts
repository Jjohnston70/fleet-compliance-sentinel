...
const SPECS: EnvVarSpec[] = [
  ...
  { name: 'FLEET_COMPLIANCE_TRAINER_NAME', category: 'OPTIONAL', reason: 'Trainer-of-record name for DOT audit package exports' },
  { name: 'FLEET_COMPLIANCE_TRAINER_ADDRESS', category: 'OPTIONAL', reason: 'Trainer-of-record address for DOT audit package exports' },
  { name: 'TRAINING_CERT_STORAGE_BACKEND', category: 'OPTIONAL', reason: 'Training certificate storage backend override (database|filesystem)' },
  { name: 'TRAINING_CERT_STORAGE_ROOT', category: 'OPTIONAL', reason: 'Filesystem root for training certificates when backend=filesystem' },
