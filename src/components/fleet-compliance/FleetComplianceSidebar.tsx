...
const NAV_ITEMS = [
  ...
  { label: 'Training', href: '/fleet-compliance/training' },
  { label: 'My Training', href: '/fleet-compliance/training/my' },
  { label: 'Training Admin', href: '/fleet-compliance/training/manage' },
