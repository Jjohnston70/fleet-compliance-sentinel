...
export default function SuspenseItemForm({ initial, returnHref = '/fleet-compliance/suspense' }: Props) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (initial) {
      updateRecord<LocalSuspenseItem>('fleet-compliance:store:suspense', initial.id, form);
    } else {
      addRecord<LocalSuspenseItem>('fleet-compliance:store:suspense', {
        id: generateId('sus'),
