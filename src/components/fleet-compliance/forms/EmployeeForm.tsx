...
export default function EmployeeForm({ initial, returnHref = '/fleet-compliance/employees' }: Props) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (initial) {
      updateRecord<LocalEmployee>('fleet-compliance:store:employees', initial.id, form);
    } else {
      ...
      addRecord<LocalEmployee>('fleet-compliance:store:employees', record);
    }
    setSaved(true);
