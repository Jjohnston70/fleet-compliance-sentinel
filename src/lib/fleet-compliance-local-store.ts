...
export type StoreKey =
  | 'fleet-compliance:store:employees'
  | 'fleet-compliance:store:assets'
  | 'fleet-compliance:store:suspense'
  | 'fleet-compliance:store:invoices';

export type SettingsKey = 'fleet-compliance:settings:alerts';
...
const RECORD_STORE_KEY = '__fleet_compliance_local_record_store_v2__';
const SETTINGS_STORE_KEY = '__fleet_compliance_local_settings_store_v2__';
