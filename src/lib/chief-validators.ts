export interface ChiefValidationResult {
  valid: boolean;
  errors: string[];
}
...
export function validateDriver(row: Record<string, string>): ChiefValidationResult {
  const errors: string[] = [];
...
export function validateAsset(row: Record<string, string>): ChiefValidationResult {
  const errors: string[] = [];
...
export function validatePermit(row: Record<string, string>): ChiefValidationResult {
  const errors: string[] = [];
...
export function validateEmployee(row: Record<string, string>): ChiefValidationResult {
  const errors: string[] = [];
