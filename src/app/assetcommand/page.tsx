...
const faqs = [
  ...
  { q: "How long does setup take?", a: "30 to 60 minutes with the automated wizard." },
  { q: "What if I get stuck?", a: "Async support via email at jacob@truenorthstrategyops.com." },
];
    ...
    <div className="min-h-screen bg-[#0d1117] text-white font-mono">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="inline-block border border-[#3d8eb9] text-[#3d8eb9] text-xs tracking-widest uppercase px-4 py-1 mb-8">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mb-4 leading-relaxed">
            ...
            <br />
            <span className="text-white font-bold">No subscription. No new software. No IT department.</span>
          </p>
          ...
          <div className="space-y-px">
            {problems.map((p, i) => (
              <div key={i} className="grid md:grid-cols-2 gap-px bg-[#1e3a5f]">
                <div className="bg-[#0a0f14] px-6 py-5 flex items-start gap-4">
                  <span className="text-red-500 mt-1 flex-shrink-0">✗</span>
                  <span className="text-gray-400 italic">{p.q}</span>
                </div>
                <div className="bg-[#0d1117] px-6 py-5 flex items-start gap-4">
                  <span className="text-[#3d8eb9] mt-1 flex-shrink-0">✓</span>
      ...
      <section className="py-20 px-6 bg-[#0a0f14]">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl font-black mb-12">Everything included for $97.</h2>
          <div className="grid md:grid-cols-2 gap-3">
            {deliverables.map((item, i) => (
              <div key={i} className="flex items-start gap-4 border border-[#1e3a5f] px-5 py-4 hover:border-[#3d8eb9] transition-colors">
                <span className="text-[#3d8eb9] font-black flex-shrink-0">{String(i + 1).padStart(2, "0")}</span>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="text-gray-600 text-xs mt-6 tracking-widest uppercase">
          30-day money back guarantee — Google account required
        </p>
      </section>
