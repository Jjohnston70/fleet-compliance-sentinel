...
import HazmatTrainingReports from '@/components/training/HazmatTrainingReports';

export const dynamic = 'force-dynamic';
export const metadata: Metadata = { title: 'Hazmat Training Reports | Fleet Compliance Sentinel' };
...
export default async function HazmatTrainingReportsPage() {
  ...
  return <HazmatTrainingReports orgId={orgId} />;
}
