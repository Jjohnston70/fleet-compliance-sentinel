...
export class EmailService {
   ...
   */
  async sendProposalEmail(payload: EmailPayload): Promise<{ success: boolean; messageId?: string }> {
   ...
   */
  private async sendViaResend(payload: EmailPayload): Promise<{ success: boolean; messageId?: string }> {
   ...
   */
  static createProposalEmailPayload(
    clientEmail: string,
    clientName: string,
    projectTitle: string,
