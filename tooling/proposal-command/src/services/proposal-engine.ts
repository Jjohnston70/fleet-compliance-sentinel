...
import { Proposal, ProposalTemplate, LineItem, PricingSummary } from '../data/firestore-schema';
...
export class ProposalEngine {
   ...
   */
  static generateProposal(data: ProposalRenderData): string {
   ...
   */
  private static buildTemplateContext(data: ProposalRenderData) {
   ...
   */
  private static renderCoverPage(data: ProposalRenderData): string {
    return `
# PROPOSAL
...
**Valid Until:** ${this.formatDate(data.proposal.validUntil)}  
   ...
   */
  private static renderPricingSection(data: ProposalRenderData): string {
...
**Valid until:** ${this.formatDate(data.proposal.validUntil)}
   ...
   */
  private static renderTermsSection(data: ProposalRenderData): string {
    return `
## Terms & Conditions
...
Authorized Representative: _________ Date: _______
   ...
   */
  private static renderLineItemsTable(lineItems: LineItem[]): string {
