...
export type ServiceType = typeof CONFIG.SERVICE_TYPES[number];
export type ProposalStatus = typeof CONFIG.PROPOSAL_STATUSES[number];
export type ActivityType = typeof CONFIG.ACTIVITY_TYPES[number];
export type PricingCategory = typeof CONFIG.PRICING_CATEGORIES[number];
