...
export function createBidDecisionAPI(
  ...
  return {
    ...
    async getBidDecision(opportunityId) {
      return service.getBidDecision(opportunityId);
    },

    async listBidDecisions() {
      return service.listBidDecisions();
    },

    async getWinRate(days) {
      return service.getWinRate(days);
    },
  };
}
