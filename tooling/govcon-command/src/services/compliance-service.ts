...
export class ComplianceService {
  ...
  /**
   * Create or add a compliance tracking item
   */
  ...
  /**
   * List all compliance items with optional filtering
   */
  ...
  /**
   * Mark item as renewed/renewed with new expiration
   */
  ...
  /**
   * Get items expiring soon (90, 60, 30, 7 days)
   */
  ...
  async getComplianceAlerts(): Promise<{
    ...
    const expiring60 = await this.getExpiringItems(COMPLIANCE_REMINDER_DAYS.warning60);

    // Remove duplicates (7-day expires are also in 30-day, etc.)
  ...
  /**
   * Check compliance status for specific authority
   */
