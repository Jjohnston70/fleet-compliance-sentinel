...
exports.DISPATCH_COMMAND_TOOLS = void 0;
exports.createDispatchToolHandlers = createDispatchToolHandlers;
exports.createDispatchTools = createDispatchTools;
...
exports.DISPATCH_COMMAND_TOOLS = [
    {
...
function createDispatchToolHandlers(repository) {
    const handlers = new handlers_1.DispatchAPIHandlers(repository);
    return {
        create_dispatch_request: async (args) => {
            const result = await handlers.createDispatchRequest({
                ...
                issue_type: asString(args.issue_type),
 ...
 */
function createDispatchTools(repository) {
    const handlers = createDispatchToolHandlers(repository);
    return exports.DISPATCH_COMMAND_TOOLS.map((tool) => ({
        name: tool.name,
 ...
 */
function createToolDefinition(handler) {
    const definition = exports.DISPATCH_COMMAND_TOOLS.find((tool) => tool.name === handler.name);
