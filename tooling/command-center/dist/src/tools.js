 ...
 */
export const COMMAND_CENTER_TOOLS = [
    {
    ...
    {
        name: 'discover_tools',
        description: 'List all available tools across all TNDS command modules. Optionally filter by module ID or classification (Operations, Finance, Intelligence, Planning, Infrastructure, Logistics). Returns qualified tool names (module.tool_name) with descriptions.',
        inputSchema: {
            type: 'object',
            properties: {
                moduleId: {
    ...
    {
        name: 'search_tools',
        description: 'Search for tools by keyword across all TNDS modules. Returns ranked results based on tool name and description match. Supports filtering by module and classification.',
        inputSchema: {
            type: 'object',
            properties: {
                query: {
    ...
    },
    {
        ...
        description: 'Get the complete parameter schema for a specific tool. Provides detailed information about what parameters the tool accepts and their types. Use the qualified name: module.tool_name.',
        inputSchema: {
            type: 'object',
            properties: {
                qualifiedName: {
    ...
    },
    {
        ...
        description: 'Execute a tool by its qualified name (module.tool_name) with provided parameters. Routes the call to the appropriate module and executes it. Returns execution status and invocation ID.',
        inputSchema: {
            type: 'object',
            properties: {
                qualifiedName: {
    ...
    },
    {
        ...
        description: 'Get comprehensive health check across all TNDS modules. Returns system status (healthy, degraded, critical) and detailed health metrics for each module.',
        inputSchema: {
            type: 'object',
            properties: {},
        },
    },
    {
        ...
        description: 'Get detailed information about a specific TNDS module including all its tools, health status, and usage statistics.',
        inputSchema: {
            type: 'object',
            properties: {
                moduleId: {
    ...
    },
    {
        ...
        description: 'List all TNDS module classifications and how many modules belong to each classification.',
        inputSchema: {
            type: 'object',
            properties: {},
        },
    },
    {
        ...
        description: 'Get system-wide dashboard with aggregate metrics: total modules, tools, classifications, and system health summary.',
        inputSchema: {
            type: 'object',
            properties: {},
        },
    },
    {
        ...
        description: 'Get tool usage statistics including most invoked tools, average response times, and error rates per module.',
        inputSchema: {
            type: 'object',
            properties: {},
        },
