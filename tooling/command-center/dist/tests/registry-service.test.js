...
describe('RegistryService', () => {
    ...
    it('should register a module', () => {
        service.registerModule('test-module', 'Test Module', '1.0.0', 'A test module', 'Operations', [
            {
                name: 'test_tool',
    ...
    it('should prevent duplicate module registration', () => {
        service.registerModule('test-module', 'Test Module', '1.0.0', 'A test module', 'Operations', []);
        expect(() => {
            service.registerModule('test-module', 'Another Test', '2.0.0', 'Different description', 'Operations', []);
