...
export const DEFAULT_COMPLIANCE_ITEMS: ComplianceSeedItem[] = [
  {
    itemType: "registration",
    name: "SAM.gov Registration",
    description:
      "System for Award Management (SAM.gov) federal contractor registration. Required to bid on federal contracts.",
    authority: "SAM",
  ...
  },
  {
    ...
    description:
      "Service-Disabled Veteran-Owned Small Business certification. Enables access to dedicated federal set-asides.",
    authority: "SBA",
  ...
  },
  {
    ...
    description:
      "Annual IRS federal income tax return filing for sole proprietorship or S-corp.",
    authority: "IRS",
    renewalFrequencyMonths: 12,
  ...
  },
  {
    ...
    description:
      "Business liability insurance coverage. Often required by contract terms.",
    authority: "state",
    renewalFrequencyMonths: 12,
    reminderDaysBefore: 60,
  },
  {
    ...
    description:
      "Dun & Bradstreet unique identifier. Often cross-referenced in federal procurement.",
    authority: "SAM",
  ...
  },
  {
    ...
    description:
      "NIST SP 800-171 compliance documentation for federal IT contracting (if applicable to contracts pursued).",
    authority: "SBA",
    renewalFrequencyMonths: 24,
    reminderDaysBefore: 90,
  },
...
export function getComplianceItemsForAuthority(
  authority: ComplianceSeedItem["authority"]
): ComplianceSeedItem[] {
