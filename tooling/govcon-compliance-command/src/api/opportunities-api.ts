...
export function createOpportunitiesAPI(service: OpportunityService): OpportunitiesAPI {
  return {
    async createOpportunity(params) {
      return service.createOpportunity(
        params.title, params.solicitation_number, params.agency,
        params.response_deadline, params.set_aside_type,
        params.naics_code, params.naics_description, params.description
      );
    },
