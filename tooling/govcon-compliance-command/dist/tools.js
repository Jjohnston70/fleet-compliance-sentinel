...
export function createToolHandlers(repo) {
    ...
    return {
        ...
        async create_opportunity(input) {
            return oppService.createOpportunity(input.title, input.solicitation_number, input.agency, new Date(input.response_deadline), input.set_aside_type, input.naics_code, input.naics_description, input.description, { estimated_value: input.estimated_value });
        },
