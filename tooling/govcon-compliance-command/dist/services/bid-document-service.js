 ...
 */
import { COMPANY_CONFIG } from "../config/index.js";
...
export class BidDocumentService {
     ...
     */
    async generateBidDocument(opportunityId, documentType, companyId, formats = ["docx", "pdf", "markdown"]) {
     ...
     */
    async generateFullBidPackage(opportunityId, companyId, formats = ["docx", "pdf", "markdown"]) {
        const documentTypes = [
        ...
        for (const docType of documentTypes) {
            const result = await this.generateBidDocument(opportunityId, docType, companyId, formats);
            documents.push({
                type: docType,
     ...
     */
    async listBidDocuments(opportunityId) {
...
//# sourceMappingURL=bid-document-service.js.map