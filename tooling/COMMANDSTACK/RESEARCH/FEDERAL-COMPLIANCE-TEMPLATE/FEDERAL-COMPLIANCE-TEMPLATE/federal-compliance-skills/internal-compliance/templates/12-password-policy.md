...
This Password Policy establishes [COMPANY_LEGAL_NAME]'s requirements for creating, managing, and protecting passwords and authentication credentials. This policy ensures strong authentication security and protects against unauthorized access to systems and data.

Scope

This policy applies to all [COMPANY_NAME] personnel, contractors, subcontractors, and any other individuals with access to company systems, applications, or data. It covers all passwords and authentication credentials for company systems, applications, and services.

Governance and Cross-Package References

This policy operates under the authority of the Security and Compliance Handbook (security-governance skill), which establishes the master governance framework for authentication and access control.

Universal [COMPANY_ABBREVIATION] Principles:
Data-as-Regulated: [COMPANY_ABBREVIATION] treats all client and customer data as regulated by default; strong passwords protect access to all data
...
security-governance skill (Security & Compliance Handbook): Master governance document establishing authentication requirements (Section 2)
internal-compliance skill (Access Control Policy): Establishes access control principles including authentication
internal-compliance skill (Encryption and Key Management): Establishes requirements for password hashing and encryption
cloud-platform-security skill (Google Workspace Security Configuration): Platform-specific password policy implementation

For access control requirements, see internal-compliance skill (Access Control Policy).
For password encryption requirements, see internal-compliance skill (Encryption and Key Management).
