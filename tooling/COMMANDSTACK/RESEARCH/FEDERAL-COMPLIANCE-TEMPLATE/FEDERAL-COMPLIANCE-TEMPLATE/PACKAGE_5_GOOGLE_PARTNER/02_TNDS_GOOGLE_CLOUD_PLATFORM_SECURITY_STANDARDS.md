...
This Google Cloud Platform Security Standards document establishes True North Data Strategies LLC's requirements for securely configuring, deploying, and managing resources on Google Cloud Platform (GCP). This standard ensures GCP resources are protected, compliant, and aligned with security best practices.

Scope

This standard applies to all True North Data Strategies Google Cloud Platform projects, resources, and services. It applies to all personnel responsible for developing, deploying, or managing GCP resources.

Governance and Cross-Package References

This standard implements TNDS security requirements on the Google Cloud Platform, leveraging FedRAMP-authorized Google infrastructure.

Universal TNDS Principles - Platform Implementation:
Data-as-Regulated: All client and customer data in GCP treated as regulated by default
No Sensitive Data in Logs: GCP logs (Cloud Logging, Cloud Monitoring, audit logs) must not contain PII, PHI, PCI, CUI in unprotected form

Cross-Package Integration:
Package 2 (Security & Compliance Handbook): Master governance document; this standard implements requirements on GCP
Package 1 (Cloud Hardening Standard): General cloud security requirements; this standard provides GCP-specific implementation
Package 1 (Network Security Policy): Network security requirements implemented via GCP VPC, firewall rules, Cloud Armor
Package 3 (Data Handling Standard): Data classification and handling requirements implemented via GCP security controls

Shared Responsibility Model:
Package 1 (Shared Responsibility Model) documents general cloud shared responsibility
This standard implements TNDS responsibilities for GCP specifically
Google responsible for security OF the cloud (infrastructure, platform, FedRAMP compliance)
TNDS responsible for security IN the cloud (data, applications, access, configuration)

For general cloud security requirements, see Package 1 (Cloud Hardening Standard).
For network security requirements, see Package 1 (Network Security Policy).

GCP Security Principles

Shared Responsibility Model
Google responsible for security of the cloud (infrastructure, platform)
True North Data Strategies responsible for security in the cloud (data, applications, access, configuration)
...
Access to GCP resources based on least privilege
...
GCP configuration supports compliance requirements
...
GCP Organization
Single GCP organization for True North Data Strategies LLC
Organization ID documented
Organization-level policies enforced
Organization administered by CISO (Jacob Johnston)
...
User authentication through Google Workspace (SSO)
...
MFA enforced through Google Workspace
...
Keys stored securely (Google Secret Manager, encrypted storage)
...
Private Google Access enabled for accessing Google APIs from private IPs
Private Service Connect used for private connectivity to Google services
...
Encryption at Rest
All data encrypted at rest by default (Google-managed encryption keys)
...
Data stored in specific GCP regions per data residency requirements
...
GCP Security Monitoring and Logging

Cloud Logging

Logging Configuration
Cloud Logging enabled for all GCP resources
...
Access Transparency Logs: Google personnel access (for compliance)
...
Cloud Monitoring enabled for all GCP resources
...
VPC Service Controls
VPC Service Controls used to create security perimeters around GCP resources
...
GCP compliance certifications: ISO 27001, SOC 2, SOC 3, PCI-DSS, HIPAA, FedRAMP
...
Security Reviews
GCP security configuration reviewed quarterly
Security findings remediated
Security review documented

Incident Response
Security incidents in GCP investigated and responded to
Incident response per Incident Response Plan
Incidents documented and lessons learned

Security Training
Personnel trained on GCP security best practices
...
GCP Administrators
Configure and manage GCP resources securely
...
CISO (Jacob Johnston)
Overall responsibility for GCP security
Approve GCP security standards
Review security metrics and incidents
Ensure compliance with security policies

Developers
Develop and deploy applications securely on GCP
Follow secure coding practices
Implement security controls in applications
Report security issues

All Personnel
Use GCP resources securely and responsibly
Protect access credentials
Report security incidents and suspicious activity
Comply with GCP security policies

Contact Information

For GCP security questions or to report security incidents, contact:
