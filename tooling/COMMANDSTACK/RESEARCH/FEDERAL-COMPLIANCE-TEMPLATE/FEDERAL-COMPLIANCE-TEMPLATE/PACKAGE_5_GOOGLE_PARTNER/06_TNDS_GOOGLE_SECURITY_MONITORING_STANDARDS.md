...
This Google Security Monitoring Standards document establishes True North Data Strategies LLC's requirements for monitoring security events and threats across Google Workspace and Google Cloud Platform. This standard ensures security events are detected, analyzed, and responded to promptly to protect company resources and data.

Scope

This standard applies to all True North Data Strategies Google Workspace and Google Cloud Platform resources. It applies to all personnel responsible for security monitoring, incident detection, and incident response.

Governance and Cross-Package References

This standard implements TNDS security monitoring requirements on Google platforms, ensuring logs and monitoring systems protect sensitive data.

Universal TNDS Principles - Monitoring Implementation:
...
Package 2 (Security & Compliance Handbook): Master governance document establishing monitoring requirements
Package 1 (Audit Logging and Monitoring Policy): General logging and monitoring requirements; this standard provides Google-specific implementation
Package 3 (Anonymization Standard): Techniques for protecting sensitive data in monitoring systems
Package 5 (Google DLP): DLP integration with monitoring to detect and prevent sensitive data in logs

Monitoring Data Protection:
Monitoring logs anonymize user identifiers per Package 3 (Anonymization Standard)
...
For general monitoring requirements, see Package 1 (Audit Logging and Monitoring Policy).
For data protection in logs, see Package 1 (Audit Logging and Monitoring Policy - Data Protection in Logs).
...
Google Workspace Security Center provides centralized security monitoring
...
SCC Overview
Security Command Center provides centralized security monitoring for GCP
...
SIEM options: Splunk, Elastic Stack (ELK), Sumo Logic, Chronicle (Google)
SIEM selected based on needs and budget

Log Aggregation
Logs from Google Workspace and GCP aggregated in SIEM
...
SIEM correlates events across Workspace and GCP
...
Feeds from: Commercial providers, open-source, Google Threat Intelligence
Feeds updated regularly

Indicator of Compromise (IOC) Monitoring
IOCs monitored across Workspace and GCP
...
SOC Staffing
CISO (Jacob Johnston) responsible for security monitoring
...
GCP and Workspace Administrators
...
24/7 Security Hotline: 555-555-5555
