...
This Google Vertex AI Governance and Responsible AI Policy establishes True North Data Strategies LLC's requirements for developing, deploying, and managing artificial intelligence and machine learning models using Google Vertex AI. This policy ensures AI systems are developed responsibly, ethically, securely, and in compliance with applicable regulations.

Scope

This policy applies to all True North Data Strategies AI and ML projects using Google Vertex AI or other AI/ML platforms. It applies to all personnel involved in developing, deploying, or managing AI/ML models and systems.

Governance and Cross-Package References

This policy implements TNDS AI/ML governance requirements on the Google Vertex AI platform, integrating with broader AI governance and data protection frameworks.

Universal TNDS Principles - AI/ML Application:
...
Package 2 (Security & Compliance Handbook): Master AI/ML Governance Framework establishing AI security principles
Package 1 (Acceptable Use Policy): AI/ML Acceptable Use section establishing approved platforms and data protection requirements
Package 3 (Data Handling Standard): Data classification and handling requirements for AI/ML data
Package 3 (Anonymization Standard): Techniques for anonymizing AI training data, prompts, and outputs

AI Data Protection Requirements:
Training data must be anonymized per Package 3 (Anonymization Standard) unless client-approved in writing
...
AI debugging and logging must protect sensitive data per Package 1 (Logging Policy)

For AI acceptable use requirements, see Package 1 (Acceptable Use Policy - AI/ML Section).
For AI governance framework, see Package 2 (Security & Compliance Handbook - AI/ML Governance).
For data anonymization techniques, see Package 3 (Anonymization Standard).
...
Committee includes: CISO (Jacob Johnston), technical leads, legal, ethics advisor (if applicable)
...
Training data stored securely in GCP (Cloud Storage, BigQuery)
...
Data Encryption
Training data and model artifacts encrypted at rest (Google-managed or customer-managed keys)
