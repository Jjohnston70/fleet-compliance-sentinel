...
This Information Security Policy establishes True North Data Strategies LLC's commitment to protecting the confidentiality, integrity, and availability of information assets. This policy provides the framework for the information security program and defines security principles, objectives, and governance.

Scope

This policy applies to all True North Data Strategies personnel, contractors, subcontractors, systems, networks, data, and facilities. It covers all information assets regardless of format or location including electronic data, paper documents, and verbal communications.

Governance and Cross-Package References

This policy operates under the authority of the Security and Compliance Handbook (Package 2), which establishes the master governance framework for all TNDS security policies and procedures. This Information Security Policy provides the foundational security principles that are implemented through detailed policies and procedures in Package 1 and across all other packages.

Universal TNDS Principles:
Data-as-Regulated: TNDS treats all client and customer data as regulated by default, requiring maximum protection across all security controls and processes
...
Package 2 (Security & Compliance Handbook): Master governance document establishing comprehensive security framework
Package 3 (Data Handling & Privacy): Authoritative source for data classification, privacy controls, and data lifecycle management
Package 4 (Government Contracting): Federal overlay applying security controls to government engagements
Package 5 (Google Platform Security): Platform-specific implementation of security controls on Google infrastructure
Package 1 (All Policies): Detailed implementation policies operating under this foundational security policy

For detailed data handling and privacy requirements, see Package 3 (Data Handling & Privacy).
For federal security requirements, see Package 4 (Government Contracting).
For platform-specific security implementation, see Package 5 (Google Platform Security).
...
Reporting: Reports to CEO (self in current structure)
