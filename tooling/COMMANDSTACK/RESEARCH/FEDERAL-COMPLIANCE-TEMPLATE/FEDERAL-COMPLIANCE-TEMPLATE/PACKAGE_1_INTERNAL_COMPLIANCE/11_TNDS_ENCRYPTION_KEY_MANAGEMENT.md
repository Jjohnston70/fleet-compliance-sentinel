...
This Encryption and Key Management Policy establishes True North Data Strategies LLC's requirements for using encryption to protect sensitive data and for managing cryptographic keys. This policy ensures data confidentiality and integrity through proper encryption and key management practices.

Scope

This policy applies to all True North Data Strategies personnel, contractors, subcontractors, systems, applications, and data. It covers encryption of data at rest, data in transit, and cryptographic key management.

Governance and Cross-Package References

This policy operates under the authority of the Security and Compliance Handbook (Package 2), which establishes the master governance framework for encryption and cryptographic controls.

Universal TNDS Principles:
Data-as-Regulated: TNDS treats all client and customer data as regulated by default; encryption protects all data as if regulated
...
Package 2 (Security & Compliance Handbook): Master governance document establishing encryption requirements (Section 4)
Package 3 (Data Handling & Privacy): Data classification determining encryption requirements
Package 5 (Google Cloud Platform Security Standards): Platform-specific encryption implementation on Google infrastructure
Package 1 (Audit Logging and Monitoring Policy): Establishes logging requirements for key management activities

For data classification and handling, see Package 3 (Data Handling Standard).
For Google Cloud encryption implementation, see Package 5 (GCP Security Standards).
...
Encryption keys managed by True North Data Strategies or trusted key management service
