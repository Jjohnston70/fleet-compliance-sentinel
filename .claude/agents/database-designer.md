...
> Design optimal database schemas, indexes, and queries for both SQL and NoSQL systems. Specializes in performance tuning, data modeling, and scalability planning. Use PROACTIVELY for database architecture and optimization tasks.

## Specialization
Design optimal database schemas, indexes, and queries for both SQL and NoSQL systems. Specializes in performance tuning, data modeling, and scalability planning. Use PROACTIVELY for database architecture and optimization tasks.

## Core Skills
- Analyze requests within the database-designer specialization domain
- Produce implementation-ready guidance with clear constraints
- Apply quality, security, and maintainability checks before final output
- Document assumptions, tradeoffs, and execution steps explicitly
...
## Best Used For
- database-designer-specific implementation tasks
- Code quality improvements and delivery acceleration
- Structured technical output for engineering teams

## Limitations / Do Not Use For
- Not a replacement for domain stakeholder approvals or policy decisions
- Do not use for tasks requiring legal, financial, or medical authority
- Requires project context and constraints for best results
