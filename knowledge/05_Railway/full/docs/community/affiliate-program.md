...
Source: https://github.com/railwayapp/docs/blob/f4594b3f032cd0266b636cdc9b6ff5e75113f851/content/docs/community/affiliate-program.md
Original Path: docs/community/affiliate-program.md
Section: docs
...
- Click the `Refer` button in the dashboard, or navigate directly to the workspace's [referrals page](https://railway.com/account/referrals).
...
- Navigate to the workspace settings and click on `Earnings`, which leads you to the [earnings page](https://railway.com/account/earnings).
