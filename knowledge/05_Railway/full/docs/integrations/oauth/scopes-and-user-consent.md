...
Source: https://github.com/railwayapp/docs/blob/f4594b3f032cd0266b636cdc9b6ff5e75113f851/content/docs/integrations/oauth/scopes-and-user-consent.md
Original Path: docs/integrations/oauth/scopes-and-user-consent.md
Section: docs
...
If the available scopes don't cover your use case, we'd love to hear about it. Share your feedback on [Central Station](https://station.railway.com) so we can learn about what you're building.
