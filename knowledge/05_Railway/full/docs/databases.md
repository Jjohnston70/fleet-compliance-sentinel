Title: Databases
Source: https://github.com/railwayapp/docs/blob/f4594b3f032cd0266b636cdc9b6ff5e75113f851/content/docs/databases.md
Original Path: docs/databases.md
Section: docs
...
Deploy and manage databases on Railway - PostgreSQL, MySQL, Redis, MongoDB, and any open source database you need.
...
- **Templates**: Browse the [database and storage templates](https://railway.com/templates?category=Storage) for pre-configured options
...
- [**All Storage Templates**](https://railway.com/deploy?category=Storage) - Browse databases, caches, and storage solutions
